...
class HandCodedLaneFollower(object):
    ...
    def steer(self, frame, lane_lines,speed):
        ...
        if self.car is not None:
            ...
            speedChange = speed - int((1.5*(90-self.curr_steering_angle))**2/(speed)*1.3)
...
def stabilize_steering_angle(curr_steering_angle, new_steering_angle, num_of_lane_lines, max_angle_deviation_two_lines=4, max_angle_deviation_one_lane=7, speed = 50):
