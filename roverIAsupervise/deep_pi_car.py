...
class DeepPiCar(object):
    ...
    def __init__(self):
        ...
        self.front_wheels.turning_offset = 14 # calibrate servo to center
    ...
    def drive(self, speed=__INITIAL_SPEED):
        ...
        #The program can lag so we have to choose another decision after some frame
        iterationToWaitForAnotherDecision = 13
        #Current iteration
        currentIteration = 0
        
        while self.camera.isOpened():
            
            if currentIteration < iterationToWaitForAnotherDecision:
                currentIteration+=1
                continue
            else:
                currentIteration = 0
